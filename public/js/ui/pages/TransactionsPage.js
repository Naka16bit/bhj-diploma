...
class TransactionsPage {
   ...
   * */
  formatDate(date) {
    const strDate = new Intl.DateTimeFormat('ru-Ru', { dateStyle: 'long' }).format(date);
    const strTime = new Intl.DateTimeFormat('ru-Ru', { timeStyle: 'short' }).format(date);

    return `${strDate} в ${strTime}`;
  }
  ...
  getTransactionHTML(item) {
    ...
    <div class="col-md-7 transaction__details">
      ...
      <div class="transaction__info">
          ...
          <!-- дата -->
          <div class="transaction__date">${this.formatDate(new Date(item.created_at))}</div>
      </div>
    </div>
    <div class="col-md-3">
  ...
  renderTransactions(data) {
    ...
    this.element.querySelector('.content').innerHTML = transactionsHtml;
  }
}